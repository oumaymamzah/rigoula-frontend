                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '0.9rem', marginBottom: '8px' }}>
                            <div className="d-flex justify-content-end mb-1">
                              ...
                              <span className="ms-2">{parseFloat(order.total).toFixed(3)} TND</span>
                            </div>
                            <div className="d-flex justify-content-end mb-1">
                              <span>Livraison:</span>
                              <span className="ms-2">8.000 TND</span>
                            </div>
                            <div className="border-top pt-1 d-flex justify-content-end fw-bold" style={{ color: '#10b981' }}>
                              <span>Total:</span>
                              <span className="ms-2">{(parseFloat(order.total) + 8).toFixed(3)} TND</span>
                            </div>
                          </div>
                        </div>
                      </Col>
