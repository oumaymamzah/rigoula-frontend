                      ...
                      <tbody>
                        {cartItems.map((item) => (
                          <tr key={item.id}>
                            ...
                            <td className="align-middle">{parseFloat(item.prix).toFixed(3)} TND</td>
                            ...
                            <td className="align-middle fw-bold">{parseFloat(item.total_ligne).toFixed(3)} TND</td>
                            <td className="align-middle">
                              <Button 
              ...
              <Card className="border-0 shadow-sm sticky-top" style={{ top: '20px' }}>
                <Card.Body>
                  ...
                  <div className="d-flex justify-content-between mb-2">
                    ...
                    <span>{(total - 8).toFixed(3)} TND</span>
                  </div>
                  <div className="d-flex justify-content-between mb-2">
                    <span>Livraison</span>
                    <span>8.000 TND</span>
