                ...
                <Col key={product.id} sm={6} lg={4} xl={3} className="mb-4">
                  <Card className="h-100 product-card">
                    ...
                    <Card.Body className="d-flex flex-column">
                      <Card.Title className="fw-bold" style={{color: '#000000', fontFamily: "'Playfair Display', serif", fontSize: '1.3rem', marginBottom: '1rem'}}>{product.nom}</Card.Title>
                      <div className="mt-auto">
                        <div className="d-flex justify-content-between align-items-center mb-3">
                          <span className="fw-bold" style={{ color: '#10b981', fontSize: '1.2rem' }}>
                            {parseFloat(product.prix).toFixed(3)} TND
                          </span>
